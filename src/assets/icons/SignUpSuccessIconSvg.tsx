...
const SignUpSuccessIconSvg: React.FC<SVGComponentPropType> = ({
  width = 172,
  height = 162,
}) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 172 162" fill="none">
      <Circle cx={85} cy={93} r={67} fill="url(#paint0_linear_182_3611)" />
      <Circle
        cx={165.5}
        cy={32.5}
        r={6.5}
        fill="url(#paint1_linear_182_3611)"
      />
      <Ellipse
        cx={10.5}
        cy={10}
        rx={10.5}
        ry={10}
        fill="url(#paint2_linear_182_3611)"
      />
      <Ellipse
        cx={5}
        cy={136.5}
        rx={5}
        ry={5.5}
        fill="url(#paint3_linear_182_3611)"
      />
      <Ellipse
        cx={153.5}
        cy={160}
        rx={2.5}
        ry={2}
        fill="url(#paint4_linear_182_3611)"
      />
      <Path
...
export default SignUpSuccessIconSvg;
